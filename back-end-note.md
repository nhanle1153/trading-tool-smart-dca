...
| MT-04 | `zone_width` xuất hiện hai chỗ với hai số phận: comment `"13?"` trong `tier_b` (dòng 2351–2353) vs `0 (hoặc 1)` trong bảng DOF (dòng 3210) | §6.9.5 vs DR-010 | 🟡 Giải ở TD-0030 | Sau khi TD-0030 kết luận là code chết → **xoá hẳn** khỏi YAML, không để lại dạng ghi chú. Comment còn đó là lời mời bật lại mà không qua DR | 06/09/2026 | — (chờ TD-0030) |
